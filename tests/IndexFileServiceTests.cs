...
public sealed class IndexFileServiceTests : IDisposable
{
    ...
    public async Task InjectionAndRemovalAreAtomicBackedUpAndIdempotent()
    {
        ...
        const string loader = "/VideoAutoplay/loader.js?v=1.1.2-rc5";
    ...
    public async Task InjectionUpgradesLegacyTagWithoutDuplicatesAndRemovalRecognizesIt(string oldLoader)
    {
        ...
        var service = new IndexFileService(_testRoot);
        const string currentLoader = "/VideoAutoplay/loader.js?v=1.1.2-rc5";
    ...
    [Theory]
    [InlineData("/VideoAutoplay/loader.js")]
    [InlineData("/VideoAutoplay/loader.js?v=1.1.2-rc5")]
    ...
    [Fact]
    public async Task AllLegacyLoaderFormatsAreRemovedTogether()
    {
        Directory.CreateDirectory(_testRoot);
        var index = Path.Combine(_testRoot, "index.html");
        ...
        var service = new IndexFileService(_testRoot);
        Assert.True((await service.InjectAsync(index, "/VideoAutoplay/loader.js?v=1.1.2-rc5", CancellationToken.None)).Success);
        ...
        Assert.DoesNotContain("VideoAutoplay/loader.js", await File.ReadAllTextAsync(index));
    }
